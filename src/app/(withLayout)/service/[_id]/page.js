...
import chkImg from "../../../../assets/images/checkout/checkout.png"
...
const SingleService = async ({ params }) => {
  ...
  const { title, img, price, description, facility } = dt;
  return (
        ...
        <div className="my-6">
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-100">
              <Image className="w-full object-cover h-40" src={chkImg} alt="checkout service" width={400} height={400}/>
